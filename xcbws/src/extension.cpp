...
/** ***************************************************************************/
XcbWS::Extension::Extension()
    : Core::Extension("org.albert.extension.xcbws"), // Must match the id in metadata
...
/** ***************************************************************************/
QWidget *XcbWS::Extension::widget(QWidget *parent) {
    if (d->widget.isNull()) {
...
/** ***************************************************************************/
void XcbWS::Extension::setupSession() {
...
/** ***************************************************************************/
void XcbWS::Extension::teardownSession() {
